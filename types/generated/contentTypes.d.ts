...
export interface ApiScoutRoleScoutRole extends Struct.CollectionTypeSchema {
  collectionName: 'scout_roles';
  info: {
    displayName: 'Role';
    pluralName: 'scout-roles';
    singularName: 'scout-role';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSectionSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    sorting: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    daysOffset: Schema.Attribute.Integer & Schema.Attribute.Required;
    locale: Schema.Attribute.String;
